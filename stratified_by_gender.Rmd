...
data_survey_ease_wide = data_survey_ease_wide[,c(1,6,3,5,4,7,8,2)]
# Rename columns if needed
...
kable_ease <- data_survey_ease_wide %>%
  kable("html", booktabs = TRUE, caption = 'How easy or hard is it to use MyConnect by Site?', align = "l") %>%
