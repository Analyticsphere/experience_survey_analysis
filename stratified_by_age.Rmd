...
data_age <- data_age %>%
  mutate(age_group = cut(age, 
                         breaks = c(seq(30, 65, by = 5), 70),  # Extend the last group to 70
                         right = FALSE,
                         labels = c(paste(seq(30, 60, by = 5), seq(34, 64, by = 5), sep = "-"), "65-70")))
```
...
colnames(data_survey_ease_wide)[7] <- "Skipped"
...
data_survey_ease_wide <- data_survey_ease_wide %>%
  mutate(across(
    starts_with("total"):starts_with("Very hard"),
...
colnames(data_survey_first_wide)[1] = "Age Groups"
...
colnames(data_survey_not_first_wide)[1] = "Age Groups"
