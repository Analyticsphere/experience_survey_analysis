...
sql_age <- glue::glue(
    "
      ...
      Connect_ID,
       d_821247024,
    DATE_DIFF(CAST(SUBSTR(d_205553981, 1, 10) AS DATE), PARSE_DATE('%Y%m%d', CAST(d_371067537 AS STRING)), DAY) / 365 AS age
  FROM
...
data_age <- data_age %>%
  mutate(age_group = cut(age, 
                         ...
                         right = FALSE,
                         labels = paste(seq(30, 65, by = 5), seq(35, 70, by = 5), sep = "-")))
```
