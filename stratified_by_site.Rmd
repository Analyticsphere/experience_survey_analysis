...
# Join total counts back to the summarized data
data_survey_time_bs <- data_survey_time_bs %>%
  left_join(site_totals, by = "site_name")
...
colnames(data_survey_time_bs_wide)[6] = "Skipped"
...
data_survey_time_bs_wide = data_survey_time_bs_wide[, c(1,4,3,5,6,2)]
...
# Join total counts back to the summarized data
data_survey_ease_bs <- data_survey_ease_bs %>%
  left_join(site_totals, by = "site_name")
...
data_survey_ease_bs_wide = data_survey_ease_bs_wide[, c(1,4,3,6,5,7,8,2)]
...
data_survey_exp_wide = data_survey_exp_wide[, c(1,3,4,5,6,7,8,2)]
