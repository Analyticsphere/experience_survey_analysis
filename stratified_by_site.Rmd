---
title: "Experience Survey Report, Stratified by Site"
author: "Leila Orszag"
...
sql_site <- glue::glue(
    "
      SELECT 
      Connect_ID,
      d_827220437 as site_name
    FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.participants_JP`
    ")
    
# Query the data and store as reference object
data_site <- dbGetQuery(con_completion, sql_site)
```

```{r, echo = FALSE}
data_site[] <- lapply(data_site, function(x) {
  if (is.character(x)) {
    x <- gsub("531629870", "Health Partners", x)
    x <- gsub("548392715", "Henry Ford", x)
    x <- gsub("125001209", "KP Colorado", x)
    x <- gsub("327912200", "KP Georgia", x)
    x <- gsub("300267574", "KP Hawaii", x)
    x <- gsub("452412599", "KP Northwest", x)
    x <- gsub("303349821", "Marshfield", x)
    x <- gsub("657167265", "Sanford", x)
    x <- gsub("809703864", "U Chicago", x)
    x <- gsub("472940358", "Baylor Scott & White", x)
    x <- gsub("517700004", "NCI", x)
    x <- gsub("181769837", "Other", x)
  }
}
)
data_site$site_name = as.factor(data_site$site_name)
```


```{r, echo = FALSE}
data_dev = left_join(data_dev, data_site, by = "Connect_ID")
```

```{r, echo = FALSE}
data_survey = left_join(data_survey, data_site, by = "Connect_ID")
```
...
colnames(device_basic) = c("Site Name", 
                           "Total Participants",
                           "Phone--Selected", 
                           "Phone--Not Selected", 
                           "Tablet--Selected", 
...
knitr::kable(device_basic, 
  ...
  kableExtra::add_header_above(c(" " = 1, "Phone" = 2, "Tablet" = 2, "Computer" = 2, " " = 1))
```
...
colnames(connect_basic) <- c("Site Name", 
                             "Total Participants",
...
# First, group by site_name and my_connect_ease, summarizing the counts
data_survey_ease <- data_survey %>%
  group_by(site_name, my_connect_ease) %>%
  summarise(Freq = n(), .groups = "drop")

# Calculate total responses per site_name
...
data_survey_ease <- data_survey_ease %>%
  left_join(site_totals, by = "site_name")
...
total_row <- colSums(data_survey_ease_wide[, -1], na.rm = TRUE)  # Exclude 'site_name' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`site_name` = "Total", total_row)  # Add the total label
...
data_survey_ease_wide = data_survey_ease_wide[,c(1,4,3,6,5,7,8,2)]
# Rename columns if needed
colnames(data_survey_ease_wide)[8] <- "Total Participants"
colnames(data_survey_ease_wide)[1] <- "Site Name"
...
# First, group by site_name and technical_issues, summarizing the counts
data_survey_tech <- data_survey %>%
  group_by(site_name, technical_issues) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_tech_wide[, -1], na.rm = TRUE)  # Exclude 'site_name' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`site_name` = "Total", total_row)  # Add the total label
...
colnames(data_survey_tech_wide)[1] <- "Site Name"
...
# First, group by site_name and finding_my_connect, summarizing the counts
data_survey_find <- data_survey %>%
  group_by(site_name, finding_my_connect) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_find_wide[, -1], na.rm = TRUE)  # Exclude 'site_name' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`site_name` = "Total", total_row)  # Add the total label
...
data_survey_find_wide = data_survey_find_wide[,c(1,3,4,5,2)]
colnames(data_survey_find_wide)[5] = "Total Participants"
colnames(data_survey_find_wide)[1] = "Site Name"
...
# First, group by site_name and comms, summarizing the counts
data_survey_comms <- data_survey %>%
  group_by(site_name, comms) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_comms_wide[, -1], na.rm = TRUE)  # Exclude 'site_name' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`site_name` = "Total", total_row)  # Add the total label
...
colnames(data_survey_comms_wide)[1] = "Site Name"
...
# First, group by site_name and info_needed, summarizing the counts
data_survey_info_needed <- data_survey %>%
  group_by(site_name, info_needed) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_info_needed_wide[, -1], na.rm = TRUE)  # Exclude 'site_name' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`site_name` = "Total", total_row)  # Add the total label
...
data_survey_info_needed_wide = data_survey_info_needed_wide[, c(1,3,4,5,2)]
colnames(data_survey_info_needed_wide)[5] = "Total Participants"
colnames(data_survey_info_needed_wide)[1] = "Site Name"
...
# First, group by site_name and first_survey_completion, summarizing the counts
data_survey_first <- data_survey %>%
  group_by(site_name, first_survey_completion) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_first_wide[, -1], na.rm = TRUE)  # Exclude 'site_name' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`site_name` = "Total", total_row)  # Add the total label
...
data_survey_first_wide = data_survey_first_wide[, c(1,3,6,4,5,7,2)]
colnames(data_survey_first_wide)[7] = "Total Participants"
colnames(data_survey_first_wide)[1] = "Site Name"
...
# First, group by site_name and why_not_first_survey, summarizing the counts
data_survey_not_first <- data_survey %>%
  group_by(site_name, why_not_first_survey) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_not_first_wide[, -1], na.rm = TRUE)  # Exclude 'site_name' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`site_name` = "Total", total_row)  # Add the total label
...
data_survey_not_first_wide$Skipped <- total_elig - rowSums(data_survey_not_first_wide[, 3:8], na.rm = TRUE)
...
data_survey_not_first_wide = data_survey_not_first_wide[, c(1,3,4,5,7,8,6,10,9)]
colnames(data_survey_not_first_wide)[9] = "Total Eligible Participants"
colnames(data_survey_not_first_wide)[1] = "Site Name"
...
# First, group by site_name and length_first_survey, summarizing the counts
data_survey_length1 <- data_survey %>%
  group_by(site_name, length_first_survey) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_length1_wide[, -1], na.rm = TRUE)  # Exclude 'site_name' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`site_name` = "Total", total_row)  # Add the total label
...
data_survey_length1_wide = data_survey_length1_wide[, c(1,5,3,4,6,2)]
colnames(data_survey_length1_wide)[6] = "Total Participants"
colnames(data_survey_length1_wide)[1] = "Site Name"
...
# First, group by site_name and biospecimen_donation, summarizing the counts
data_survey_biospec <- data_survey %>%
  group_by(site_name, biospecimen_donation) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_biospec_wide[, -1], na.rm = TRUE)  # Exclude 'site_name' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`site_name` = "Total", total_row)  # Add the total label
...
data_survey_biospec_wide = data_survey_biospec_wide[, c(1,3,4,5,6,2)]
colnames(data_survey_biospec_wide)[6] = "Total Participants"
colnames(data_survey_biospec_wide)[1] = "Site Name"
...
# First, group by site_name and comms_biospeciment_donation, summarizing the counts
data_survey_comm_bs <- data_survey %>%
  group_by(site_name, comms_biospeciment_donation) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_comm_bs_wide[, -1], na.rm = TRUE)  # Exclude 'site_name' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`site_name` = "Total", total_row)  # Add the total label
...
data_survey_comm_bs_wide$Skipped = data_survey_comm_bs_wide$total - rowSums(data_survey_comm_bs_wide[, 3:7], na.rm = TRUE)
...
data_survey_comm_bs_wide = data_survey_comm_bs_wide[, c(1,5,4,3,6,2,9,8)]
colnames(data_survey_comm_bs_wide)[8] = "Total Eligible Participants"
colnames(data_survey_comm_bs_wide)[1] = "Site Name"
...
# First, group by site_name and time_biospecimen_donation, summarizing the counts
data_survey_time_bs <- data_survey %>%
  filter(biospecimen_donation == "Yes") %>%
  group_by(site_name, time_biospecimen_donation) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_time_bs_wide[, -1], na.rm = TRUE)  # Exclude 'site_name' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`site_name` = "Total", total_row)  # Add the total label
...
colnames(data_survey_time_bs_wide)[1] = "Site Name"
...
# First, group by site_name and ease_donating_samples, summarizing the counts
data_survey_ease_bs <- data_survey %>%
  filter(biospecimen_donation == "Yes") %>%
  group_by(site_name, ease_donating_samples) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_ease_bs_wide[, -1], na.rm = TRUE)  # Exclude 'site_name' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`site_name` = "Total", total_row)  # Add the total label
...
data_survey_ease_bs_wide = data_survey_ease_bs_wide[, c(1,6,4,5,2,3,9,8)]
colnames(data_survey_ease_bs_wide)[8] = "Total Participants"
colnames(data_survey_ease_bs_wide)[1] = "Site Name"
...
data_survey_exp <- data_survey %>%
  filter(biospecimen_donation=="Yes")%>%
  group_by(site_name, exp_dontating_samples) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_exp_wide[, -1], na.rm = TRUE)  # Exclude 'site_name' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`site_name` = "Total", total_row)  # Add the total label
...
data_survey_exp_wide$Skipped = data_survey_exp_wide$total - rowSums(data_survey_exp_wide[, 3:7], na.rm = TRUE)

# Calculate percentages for each response and format them in parentheses
data_survey_exp_wide <- data_survey_exp_wide %>%
  mutate(across(starts_with("Very"):starts_with("Skipped"),
                ~ paste0(.x, " (", round(.x / total * 100, 1), "%)"),
                .names = "{.col}")) # Creating formatted strings

data_survey_exp_wide = data_survey_exp_wide[, c(1,7,5,4,3,2,9,8)]
colnames(data_survey_exp_wide)[8] = "Total Participants"
colnames(data_survey_exp_wide)[1] = "Site Name"
...
# First, group by site_name and sample_survey_completion, summarizing the counts
data_survey_ss <- data_survey %>%
  group_by(site_name, sample_survey_completion) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_ss_wide[, -1], na.rm = TRUE)  # Exclude 'site_name' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`site_name` = "Total", total_row)  # Add the total label
...
data_survey_ss_wide = data_survey_ss_wide[, c(1,3,4,5,6,2)]
colnames(data_survey_ss_wide)[6] = "Total Participants"
colnames(data_survey_ss_wide)[1] = "Site Name"
...
# First, group by site_name and at_visit_sample_survey, summarizing the counts
data_survey_vss <- data_survey %>%
  group_by(site_name, at_visit_sample_survey) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_vss_wide[, -1], na.rm = TRUE)  # Exclude 'site_name' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`site_name` = "Total", total_row)  # Add the total label
...
colnames(data_survey_vss_wide)[1] = "Site Name"
...
samp_basic <- data_dev %>%
  ...
  left_join(samp_participants_total, by = "site_name")
  
# Ensure that the values in the wide table are numeric
samp_basic[, -1] <- lapply(samp_basic[, -1], as.numeric)

# Add a total row using colSums
total_row <- colSums(samp_basic[, -1], na.rm = TRUE)  # Exclude 'site_name' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`site_name` = "Total", total_row)  # Add the total label
...
# First, group by site_name and why_not_sample_survey, summarizing the counts
data_survey_not_ss <- data_survey %>%
  group_by(site_name, why_not_sample_survey) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_not_ss_wide[, -1], na.rm = TRUE)  # Exclude 'site_name' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`site_name` = "Total", total_row)  # Add the total label
...
data_survey_not_ss_wide$Skipped = data_survey_not_ss_wide$total - rowSums(data_survey_not_ss_wide[, 3:8], na.rm = TRUE)
...
data_survey_not_ss_wide = data_survey_not_ss_wide[, c(1,3:5, 7,8,6,10,9)]
colnames(data_survey_not_ss_wide)[9] = "Total Eligible Participants"
colnames(data_survey_not_ss_wide)[1] = "Site Name"
...
data_survey_sslen <- data_survey %>%
  group_by(site_name, survey_length_pref) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_sslen_wide[, -1], na.rm = TRUE)  # Exclude 'site_name' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`site_name` = "Total", total_row)  # Add the total label
...
data_survey_sslen_wide = data_survey_sslen_wide[, c(1,4,3,5,6,2)]
colnames(data_survey_sslen_wide)[6] = "Total Participants"
colnames(data_survey_sslen_wide)[1] = "Site Name"
...
# First, group by site_name and overall_experience, summarizing the counts
data_survey_over <- data_survey %>%
  group_by(site_name, overall_experience) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_over_wide[, -1], na.rm = TRUE)  # Exclude 'site_name' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`site_name` = "Total", total_row)  # Add the total label
...
data_survey_over_wide = data_survey_over_wide[, c(1,7,6,5,3,4,8,2)]
colnames(data_survey_over_wide)[8] = "Total Participants"
colnames(data_survey_over_wide)[1] = "Site Name"
