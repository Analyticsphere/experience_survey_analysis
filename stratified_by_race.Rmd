---
title: "Experience Survey Report, Stratified by Race"
author: "Leila Orszag"
...
sql_race1 <- glue::glue(
    "
      ...
      D_384191091_D_384191091_D_458435048 AS black, 
      D_384191091_D_384191091_D_583826374 AS native_american, 
      D_384191091_D_384191091_D_586825330 AS pacific_islander, 
      D_384191091_D_384191091_D_636411467 AS asian, 
      D_384191091_D_384191091_D_706998638 AS hispanic, 
      D_384191091_D_384191091_D_746038746 AS declined, 
      D_384191091_D_384191091_D_807835037 AS other, 
      D_384191091_D_384191091_D_973565052 AS middle_eastern
    FROM `nih-nci-dceg-connect-prod-6d04.FlatConnect.module1_v2_JP`
    ")
    
# Query the data and store as reference object
data_race1 <- dbGetQuery(con_completion, sql_race1)
```
...
# Query the data and store as reference object
data_race2 <- dbGetQuery(con_completion, sql_race2)
```

```{r, echo = FALSE}
data_race = data_race1 %>%
  left_join(data_race2, by = "Connect_ID", suffix = c("_1", "_2")) %>%
  mutate(
    white = as.integer(coalesce(white_1, white_2)),
    black = as.integer(coalesce(black_1, black_2)),
    native_american = as.integer(coalesce(native_american_1, native_american_2)),
    pacific_islander = as.integer(coalesce(pacific_islander_1, pacific_islander_2)),
    asian = as.integer(coalesce(asian_1, asian_2)),
    hispanic = as.integer(coalesce(hispanic_1, hispanic_2)),
    declined = as.integer(coalesce(declined_1, declined_2)),
    other = as.integer(coalesce(other_1, other_2)),
    middle_eastern = as.integer(coalesce(middle_eastern_1, middle_eastern_2)),
    race = case_when(
      white + black + native_american + pacific_islander + asian + 
        hispanic + declined + other + middle_eastern > 1 ~ "Multiracial",
      white == 1 ~ "White",
      black == 1 ~ "Black",
...
```{r, echo=FALSE}
data_race$race = factor(data_race$race, levels = c("White", "Black", "Native American", "Pacific Islander", "Asian", "Middle Eastern", "Hispanic", "Multiracial", "Other", "Declined"))
```
...
```{r, echo = FALSE}
data_dev = left_join(data_dev, data_race, by = "Connect_ID")
```

```{r, echo = FALSE}
data_survey = left_join(data_survey, data_race, by = "Connect_ID")
```
...
colnames(device_basic) = c("Race/Ethnicity", 
                           "Total Participants",
                           "Phone--Selected", 
                           "Phone--Not Selected", 
                           "Tablet--Selected", 
...
colnames(connect_basic) <- c("Race/Ethnicity", 
                             "Total Participants",
...
data_survey_ease <- data_survey %>%
  group_by(race, my_connect_ease) %>%
  summarise(Freq = n(), .groups = "drop")

# Calculate total responses per race
race_totals <- data_survey %>%
  group_by(race) %>%
  summarise(total = n(), .groups = "drop")
...
total_row <- colSums(data_survey_ease_wide[, -1], na.rm = TRUE)  # Exclude 'race' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`race` = "Total", total_row)  # Add the total label
...
colnames(data_survey_ease_wide)[1] <- "Race/Ethnicity"
...
# First, group by race and technical_issues, summarizing the counts
data_survey_tech <- data_survey %>%
  group_by(race, technical_issues) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_tech_wide[, -1], na.rm = TRUE)  # Exclude 'race' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`race` = "Total", total_row)  # Add the total label
...
colnames(data_survey_tech_wide)[1] <- "Race/Ethnicity"
...
# First, group by race and finding_my_connect, summarizing the counts
data_survey_find <- data_survey %>%
  group_by(race, finding_my_connect) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_find_wide[, -1], na.rm = TRUE)  # Exclude 'race' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`race` = "Total", total_row)  # Add the total label
...
colnames(data_survey_find_wide)[1] = "Race/Ethnicity"
...
# First, group by race and comms, summarizing the counts
...
# Add a total row using colSums
total_row <- colSums(data_survey_comms_wide[, -1], na.rm = TRUE)  # Exclude 'race' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`race` = "Total", total_row)  # Add the total label
...
colnames(data_survey_comms_wide)[1] = "Race/Ethnicity"
...
# First, group by race and info_needed, summarizing the counts
data_survey_info_needed <- data_survey %>%
  group_by(race, info_needed) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_info_needed_wide[, -1], na.rm = TRUE)  # Exclude 'race' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`race` = "Total", total_row)  # Add the total label
...
colnames(data_survey_info_needed_wide)[1] = "Race/Ethnicity"
...
# First, group by race and first_survey_completion, summarizing the counts
data_survey_first <- data_survey %>%
  group_by(race, first_survey_completion) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_first_wide[, -1], na.rm = TRUE)  # Exclude 'race' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`race` = "Total", total_row)  # Add the total label
...
colnames(data_survey_first_wide)[1] = "Race/Ethnicity"
...
# First, group by race and why_not_first_survey, summarizing the counts
data_survey_not_first <- data_survey %>%
  group_by(race, why_not_first_survey) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_not_first_wide[, -1], na.rm = TRUE)  # Exclude 'race' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`race` = "Total", total_row)  # Add the total label
...
data_survey_not_first_wide = data_survey_not_first_wide[, c(1,2,3,4,5,6,7,10,9)]
colnames(data_survey_not_first_wide)[9] = "Total Eligible Participants"
colnames(data_survey_not_first_wide)[1] = "Race/Ethnicity"
...
# First, group by race and length_first_survey, summarizing the counts
data_survey_length1 <- data_survey %>%
  group_by(race, length_first_survey) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_length1_wide[, -1], na.rm = TRUE)  # Exclude 'race' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`race` = "Total", total_row)  # Add the total label
...
colnames(data_survey_length1_wide)[1] = "Race/Ethnicity"
...
# First, group by race and biospecimen_donation, summarizing the counts
data_survey_biospec <- data_survey %>%
  group_by(race, biospecimen_donation) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_biospec_wide[, -1], na.rm = TRUE)  # Exclude 'race' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`race` = "Total", total_row)  # Add the total label
...
colnames(data_survey_biospec_wide)[1] = "Race/Ethnicity"
...
# First, group by race and comms_biospeciment_donation, summarizing the counts
data_survey_comm_bs <- data_survey %>%
  group_by(race, comms_biospeciment_donation) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_comm_bs_wide[, -1], na.rm = TRUE)  # Exclude 'race' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`race` = "Total", total_row)  # Add the total label
...
colnames(data_survey_comm_bs_wide)[1] = "Race/Ethnicity"
...
# First, group by race and time_biospecimen_donation, summarizing the counts
data_survey_time_bs <- data_survey %>%
  filter(biospecimen_donation == "Yes")%>%
  group_by(race, time_biospecimen_donation) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_time_bs_wide[, -1], na.rm = TRUE)  # Exclude 'race' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`race` = "Total", total_row)  # Add the total label
...
colnames(data_survey_time_bs_wide)[6] = "Total Eligible Participants"
colnames(data_survey_time_bs_wide)[1] = "Race/Ethnicity"
...
# First, group by race and ease_donating_samples, summarizing the counts
data_survey_ease_bs <- data_survey %>%
  filter(biospecimen_donation == "Yes")%>%
  group_by(race, ease_donating_samples) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_ease_bs_wide[, -1], na.rm = TRUE)  # Exclude 'race' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`race` = "Total", total_row)  # Add the total label
...
colnames(data_survey_ease_bs_wide)[8] = "Total Eligible Participants"
colnames(data_survey_ease_bs_wide)[1] = "Race/Ethnicity"
...
data_survey_exp <- data_survey %>%
  filter(biospecimen_donation == "Yes")%>%
  group_by(race, exp_dontating_samples) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_exp_wide[, -1], na.rm = TRUE)  # Exclude 'race' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`race` = "Total", total_row)  # Add the total label
...
colnames(data_survey_exp_wide)[1] = "Race/Ethnicity"
...
# First, group by race and sample_survey_completion, summarizing the counts
data_survey_ss <- data_survey %>%
  group_by(race, sample_survey_completion) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_ss_wide[, -1], na.rm = TRUE)  # Exclude 'race' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`race` = "Total", total_row)  # Add the total label
...
colnames(data_survey_ss_wide)[1] = "Race/Ethnicity"
...
# First, group by race and at_visit_sample_survey, summarizing the counts
data_survey_vss <- data_survey %>%
  group_by(race, at_visit_sample_survey) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_vss_wide[, -1], na.rm = TRUE)  # Exclude 'race' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`race` = "Total", total_row)  # Add the total label
...
colnames(data_survey_vss_wide)[1] = "Race/Ethnicity"
...
samp_basic <- data_dev %>%
  ...
  left_join(samp_participants_total, by = "race")
...
# Rename columns for display
colnames(samp_basic) <- c("Race/Ethnicity", 
                             "Provided by Healthcare--Selected", 
                             "Provided by Healthcare--Not Selected", 
                             "Borrowed--Selected", 
                             "Borrowed--Not Selected",
...
# First, group by race and why_not_sample_survey, summarizing the counts
data_survey_not_ss <- data_survey %>%
  group_by(race, why_not_sample_survey) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_not_ss_wide[, -1], na.rm = TRUE)  # Exclude 'race' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`race` = "Total", total_row)  # Add the total label
...
data_survey_not_ss_wide$Skipped = data_survey_not_ss_wide$total - rowSums(data_survey_not_ss_wide[, c(2:6, 8)], na.rm = TRUE)
...
data_survey_not_ss_wide = data_survey_not_ss_wide[, c(1,2:5,8,6,10,9)]
colnames(data_survey_not_ss_wide)[9] = "Total Eligible Participants"
colnames(data_survey_not_ss_wide)[1] = "Race/Ethnicity"
...
data_survey_sslen <- data_survey %>%
  group_by(race, survey_length_pref) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_sslen_wide[, -1], na.rm = TRUE)  # Exclude 'race' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`race` = "Total", total_row)  # Add the total label
...
colnames(data_survey_sslen_wide)[1] = "Race/Ethnicity"
...
# First, group by race and overall_experience, summarizing the counts
data_survey_over <- data_survey %>%
  group_by(race, overall_experience) %>%
  summarise(Freq = n(), .groups = "drop")
...
# Add a total row using colSums
total_row <- colSums(data_survey_over_wide[, -1], na.rm = TRUE)  # Exclude 'race' for summation
total_row <- as.data.frame(t(total_row))  # Transpose to make it a row
total_row <- cbind(`race` = "Total", total_row)  # Add the total label
...
colnames(data_survey_over_wide)[1] = "Race/Ethnicity"
